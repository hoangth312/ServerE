...
@interface DDTTYLogger : DDAbstractLogger <DDsLogger>
{
	NSCalendar *calendar;
...
/* Inherited from the DDsLogger protocol:
 * 
...
/**
 * Similar to the methods above, but allows you to map DDsLogMessage->tag to a particular color profile.
 * For example, you could do something like this:
 * 
 * static NSString *const PurpleTag = @"PurpleTag";
 * 
 * #define DDsLogPurple(frmt, ...) LOG_OBJC_TAG_MACRO(NO, 0, 0, 0, PurpleTag, frmt, ##__VA_ARGS__)
 * 
 ...
 * [DDsLog aDDsLogger:[DDTTYLogger sharedInstance]];
 * 
 * This would essentially give you a straight NSLog replacement that prints in purple:
 * 
 * DDsLogPurple(@"I'm a purple log message!");
**/
#if TARGET_OS_IPHONE
