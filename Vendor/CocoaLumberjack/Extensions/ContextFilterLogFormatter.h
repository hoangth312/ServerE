 ...
 * These come from the underlying logging macros defined in DDsLog.h.
...
**/
@interface ContextWhitelistFilterLogFormatter : NSObject <DDsLogFormatter>
...
**/
@interface ContextBlacklistFilterLogFormatter : NSObject <DDsLogFormatter>
