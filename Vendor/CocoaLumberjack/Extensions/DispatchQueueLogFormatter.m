...
- (NSString *)queueThreadLabelForLogMessage:(DDsLogMessage *)logMessage
{
	// As per the DDsLogFormatter contract, this method is always invoked on the same thread/dispatch_queue
